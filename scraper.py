    ...
    for day in range(1,numeroDias + 1):
        if numObitosCausaNaturalArray[numeroDias-day] == '0':
            ...
            document.write(date[2] + "-" + monthNumber(date[0]) + '-' + str(numeroDias + 1 - day) + ','
                 ...
                 + numAcidenteTrabalhoArray[numeroDias-day] + ','
                 + numAcidenteTransitoArray[numeroDias-day] + ','
                 + numEventualSuicidioArray[numeroDias-day] + ','
                 + numEventualHomicidioArray[numeroDias-day] + ','
                 + numOutrosAcidentesArray[numeroDias-day] + ','
                 + numIgnoradoArray[numeroDias-day] + '\n')
