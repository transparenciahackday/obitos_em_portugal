...
# ------------------------- get -----------------------
'''
First we do a get,scan the page and create de database file for the first month
'''

c.execute('''CREATE TABLE data
             (data text, 
                numObitosCausaNatural integer,  
                numObitosCausaNaoNatural integer,  
                numObitosSujeitoInvestigacao integer,  
                numAcidenteTrabalho integer,  
                numAcidenteTransito integer,  
                numEventualSuicidio integer,  
                numEventualHomicidio integer,  
                numOutrosAcidentes integer,  
                numIgnorado integer
                )''')

#document = open('obitos.csv', 'w')
